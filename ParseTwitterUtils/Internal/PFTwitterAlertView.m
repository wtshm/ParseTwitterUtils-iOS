...
@interface PFTwitterAlertView () <UIAlertViewDelegate>

@property (nonatomic, copy) PFTwitterAlertViewCompletion completion;

@end

@implementation PFTwitterAlertView
...
+ (void)showAlertWithTitle:(NSString *)title
         ...
         otherButtonTitles:(NSArray *)otherButtonTitles
                completion:(PFTwitterAlertViewCompletion)completion {
    if ([UIAlertController class] != nil) {
        ...
        __block PFTwitterAlertView *pfAlertView = [[self alloc] init];
